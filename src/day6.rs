...
fn main() {
    ...
    let game = Race::from((*nums.get(1).unwrap(), *nums.first().unwrap()));
...
mod tests {
    ...
    fn test_part2() {
        ...
        let race = Race::from((*nums.get(1).unwrap(), *nums.first().unwrap()));
